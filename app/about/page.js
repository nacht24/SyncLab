    ...
    <div className="max-w-6xl mx-auto py-20 px-6">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-stretch mb-24">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h1 className="text-5xl font-black mb-6 leading-[1.1] text-slate-50">
        ...
        <div className="bg-deep-surface rounded-3xl border border-slate-800/50 relative overflow-hidden group shadow-2xl flex flex-col p-6 min-h-[480px]">
          
          {/* TERMINAL BOX */}
          <div className="bg-[#020617] rounded-2xl border border-slate-800/50 p-5 font-mono text-[10px] leading-relaxed shadow-inner h-[240px] overflow-hidden relative">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {[
          ...
          <div key={i} className="p-8 bg-deep-surface/40 rounded-2xl border border-slate-800/30 hover:border-sync-teal/20 transition-all">
            <h3 className="text-lg font-bold mb-3 text-slate-100">{item.t}</h3>
      ...
      {/* SECTION 3: SYSTEM ARCHITECTS (The Team) */}
        ...
        <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-slate-50 uppercase tracking-tighter">Core System <span className="text-sync-emerald">Architects</span></h2>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
            {/* BADGE 1: HAMZAH (Chairman) */}
            <div className="bg-slate-900/40 backdrop-blur-md border border-slate-800/60 rounded-2xl p-8 relative overflow-hidden group hover:border-sync-teal/50 transition-all duration-500 shadow-xl">
            ...
            <div className="flex justify-between items-start mb-8">
                <div className="w-12 h-12 rounded-xl bg-slate-950 border border-slate-800 flex items-center justify-center group-hover:border-sync-teal/50 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#14b8a6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                </div>
            ...
            <div className="space-y-1 mb-8">
                <h3 className="text-xl font-black text-slate-50 leading-tight uppercase tracking-tight">Hamzah Permata Putra</h3>
            ...
            {/* BADGE 2: ANGGARA */}
            <div className="bg-slate-900/40 backdrop-blur-md border border-slate-800/60 rounded-2xl p-8 relative overflow-hidden group hover:border-slate-500/50 transition-all duration-500 shadow-xl">
            <div className="flex justify-between items-start mb-8">
                <div className="w-12 h-12 rounded-xl bg-slate-950 border border-slate-800 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#64748b" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
                </div>
                <div className="text-right">
            ...
            <div className="space-y-1 mb-8">
                <h3 className="text-xl font-black text-slate-200 leading-tight uppercase tracking-tight">Muhamad Anggara Ramadhan</h3>
            ...
            <div className="space-y-1 mb-8">
                <h3 className="text-xl font-black text-slate-200 leading-tight uppercase tracking-tight">Murfid Muhyiddin</h3>
